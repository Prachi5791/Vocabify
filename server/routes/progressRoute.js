...
router.post('/progress', async (req, res) => {
    ...
    try {
      ...
      if (existingLevel) {
        ...
        // If the level doesn't exist, add a new level with the module progress
      ...
      // Recalculate total progress (if necessary)
  ...
  router.get('/progress', async (req, res) => {
    ...
    try {
      ...
      // Return the entire progress data for the user
      res.json(progress);
